...
function cargar_scripts_deportivos() {
    // Solo cargar en la página que necesites (ajusta 'calendario' por el slug de tu página)
    if ( is_page('calendario') ) {
        wp_enqueue_script('fullcalendar', 'https://cdn.jsdelivr.net/npm/fullcalendar@6.1.11/index.global.min.js', array(), null, true);
    }
}
